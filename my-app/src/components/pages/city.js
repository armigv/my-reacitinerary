...
export default function City() {
  ...
  const itineselecter = itineraries.filter((itine) =>  itine.about === itine.about)
                ...
                <div className="card-itineraries" style={{ border: "width:18rem;" }}>
                  ...
                  <div className="card-body">
                    <div key={itineraries._id} className="card-content-item">
                      ...
                      <p className="card-text"  style={{ alignitems: "right;" }} >{itineraries.price}</p>

                      <div className="card-comments">
                        <Comment itinerario={itineraries._id} />
                      </div>
